...
import CommunicationSection from "../components/Accounts/Communication/CommunicationSection"; // исправь путь если нужно
...
export default function Accounts() {
  return (
    <div className="min-h-screen bg-[#181B2A] px-0 py-8 relative flex flex-col">
      ...
      {/* Winnability секция с левой панелью */}
      <div className="mt-20 flex flex-col gap-4 ml-8">
        {/* Account Details надпись над Winnability */}
        <div className="mb-4">
      ...
      {/* CommunicationSection — теперь строго в самом низу */}
