...
export default function MyAccounts() {
  ...
  return (
    <Card className="bg-[#23263A] rounded-2xl border border-white/20 p-4 sm:p-6 lg:p-8 shadow-lg w-full max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center mb-2 gap-2 md:gap-0">
        <h2 className="text-lg lg:text-xl font-semibold text-white mr-0 md:mr-6 mb-2 md:mb-0">
          My accounts
        </h2>
        <div className="flex flex-wrap gap-2 items-center">
          <input
            type="text"
            placeholder="Search"
            className="bg-[#181C2F] rounded-full px-4 sm:px-5 py-1.5 text-white text-sm outline-none w-36 sm:w-44"
          />
          <button className="border border-blue-500 text-blue-400 bg-transparent rounded-full px-4 sm:px-5 py-1.5 text-sm font-semibold transition hover:bg-blue-500/10">
            Filter
          </button>
          <button className="border border-blue-500 text-blue-400 bg-transparent rounded-full px-4 sm:px-5 py-1.5 text-sm font-semibold transition hover:bg-blue-500/10">
            Sort
          ...
          <button className="bg-blue-500 text-white rounded-full px-4 sm:px-5 py-1.5 text-sm font-semibold">
            + New
          </button>
        </div>
      </div>
      <div className="overflow-x-auto">
        <table className="w-full text-left text-xs lg:text-sm min-w-[900px]">
          <thead>
            ...
            {accounts.map((acc, idx) => (
              ...
              >
                <td className="py-2 px-2">
                  ...
                  <div className="text-[10px] lg:text-xs text-[#A0A3C2]">
                    {acc.type}
                  </div>
                </td>
                <td className="py-2 px-2">
                ...
                <td className="py-2 px-2">
                  <span
                    className={`px-1 py-0.5 rounded-full text-[10px] lg:text-xs font-semibold ${
                ...
                <td className="py-2 px-2">
                  <span
                    className="w-16 flex justify-center items-center px-0 py-0.5 rounded-full text-[10px] lg:text-xs font-medium"
                    style={{
                      background: "#2a3fa4",
                      color: "#fff",
                      minWidth: "4rem",
                ...
                <td className="py-2 px-2">
                  <span className="flex items-center gap-1">
                    ...
                    ></span>
                    <span
                      className={`font-semibold text-[10px] lg:text-xs text-white-400`}
                    >
                      {acc.status}
                    </span>
                  </span>
                ...
                <td className="py-2 px-1">
                  <span className="inline-block bg-blue-900 text-blue-300 font-bold text-xs lg:text-sm rounded-full px-3 py-0.5 tracking-wide">
                    {acc.triage}
                  </span>
                </td>
                <td className="py-1.5 px-1.2">
                  <span className="flex items-center border border-blue-400 rounded-full px-3 py-0.5 gap-2 bg-transparent">
                    ...
                    <span className="text-blue-300 text-[12px] lg:text-sm font-medium ml-1">
