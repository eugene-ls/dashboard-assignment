...
export default function MarketIntelligence() {
  return (
    <Card className="bg-[#23263A] rounded-2xl border border-white/20 p-4 sm:p-6 lg:p-8 shadow-lg w-full max-w-xl lg:max-w-2xl mx-auto">
      <h2 className="text-lg lg:text-xl font-semibold mb-4 text-white">Market intelligence</h2>
      <ul className="space-y-2">
        {news.map((item, idx) => (
          <li key={idx} className="flex items-start gap-3">
            ...
            ></span>
            <span className="text-white text-xs lg:text-sm">{item.text}</span>
          </li>
        ))}
      </ul>
    </Card>
